			...
			<div class="row">
				<div class="filter-fieldset">
					...
					<div class="detail-part">
						<div class="detail" style="text-align: center;">
							<div class="detail-head"><%=Constants.PROP_RESULT_LINK%>:<a
									href="http://${result.getOriginalLink()}">
									${result.getOriginalLink()} </a>
							</div>
						</div>
					...
					<div class="detail-part">
						...
						<div class="detail">
							<div class="detail-head"><%=Constants.HEAD_RESULT_VALUE_MIN%>:
								<span class="detail-content">${result.getValueMin()}</span>
							</div>
						</div>
						<div class="detail">
							<div class="detail-head"><%=Constants.HEAD_RESULT_VALUE_MAX%>:
								<span class="detail-content">${result.getValueMax()}</span>
							</div>
						</div>
						<div class="detail">
					...
					<div class="detail-part">
						...
						<c:if
							...
							<div class="detail">
								<div class="detail-head"><%=Constants.PROP_CITIZENSHIP%>:
									<span class="detail-content">${result.getStudentCitizenship()}</span>
								</div>
							</div>
						</c:if>
					...
					<div class="detail-part">
						...
						<c:if test="${school != null && !school['empty']}">
							...
							<c:if
								...
								<div class="detail">
									<div class="detail-head"><%=Constants.HEAD_RESULT_FAX%>:
										<span class="detail-content">${school.getFax()}</span>
									</div>
								</div>
							</c:if>
