...
public class HibernateUtil {
	...
	public static void CreateIndexDatabase() throws InterruptedException {
		System.out.println("Create index database files..........");
		// create index data from existent database
